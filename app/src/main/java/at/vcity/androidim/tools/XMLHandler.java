...
public class XMLHandler extends DefaultHandler
{
		...
		private Vector<FriendInfo> mUsers = new Vector<FriendInfo>();
		...
		{
			FriendInfo[] users = new FriendInfo[mUsers.size()];
			...
			//changed
			this.updater.updateData(messages, users, null, userKey);
			super.endDocument();
		}		
		...
		{				
			if (localName == "friend")
			{
				...
				friend.password = attributes.getValue(FriendInfo.PASSWORD);
				friend.port = attributes.getValue(FriendInfo.PORT);
				friend.userKey = attributes.getValue(FriendInfo.USER_KEY);
				friend.Id = attributes.getValue(FriendInfo.EMAIL);
				friend.age = attributes.getValue(FriendInfo.AGE);
				friend.sex = attributes.getValue(FriendInfo.SEX);
				friend.bio = attributes.getValue(FriendInfo.BIO);

				System.out.println("XMLHandler startElement " + friend.age + " friend.age " + friend.sex + " friend.sex " + friend.bio + " friend.bio ");
