...
public class SocketOperator implements ISocketOperator
{
	...
	{		
		...
		try 
		{
			...
			//Here we put pass the username and password as params to index.php
			PrintWriter out = new PrintWriter(connection.getOutputStream());//iii88
