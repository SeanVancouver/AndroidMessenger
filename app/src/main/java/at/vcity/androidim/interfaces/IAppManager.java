...
//	public void setUserKey(String value);
	...
	public String updateUser(String usernameText, String passwordText, String email);

	public String LoadProfileInfo(int CurrentUserId);

	public String deleteAccount(String CurrentUserId)throws UnsupportedEncodingException ;
