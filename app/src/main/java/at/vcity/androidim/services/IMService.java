...
//updateUser
	...
	public String updateUser(String age, String sex,
							 String bio)
	{

		String params = "username=" + Login.currentUser +	"&password=" + Login.currentPass + "&sex=" + sex + "&age=" + age +"&bio=" + bio+ "&action=" + "updateProfile"+"&";

		String result = socketOperator.sendHttpRequest(params);
		System.out.println(" IMService updateUser result " +result);
		return result;
	}
	...
	private String getFriendList() throws UnsupportedEncodingException 	{		
        ...
        //Here we catch the zero if failed.
       // String password = "aaaaa";
		 rawFriendList = socketOperator.sendHttpRequest(getAuthenticateUserParams(username, password)); //but where does the username comes from?
			...
			String emailText)
	{
		...
		String result = socketOperator.sendHttpRequest(params);//iii377
	...
	public String LoadProfileInfo (int CurrentUserId)
	{
		String params = "username=" + Login.currentUser +	"&password=" + Login.currentPass +"&clickedId=" + CurrentUserId + "&action=" + "LoadProfileInfo"+"&";

		String result = socketOperator.sendHttpRequest(params);
		System.out.println(" IMService LoadProfileInfo result " + result);
		return result;

	}

	public String deleteAccount (String CurrentUserId)
	{
		String params = "username=" + Login.currentUser +	"&password=" + Login.currentPass + "&currentId=" + CurrentUserId + "&action=" + "deleteAccount"+"&";

		String result = socketOperator.sendHttpRequest(params);

		System.out.println(" IMService deleteAccount result " + result + " CurrentUserId " + CurrentUserId);
		return result;
	}
